  ...
  return (
    <footer className="bg-stone-900 text-stone-300 py-16 border-t border-stone-800" id="contato-footer">
      <div className="container mx-auto px-4">
        {/* Grid ajustado para 3 colunas, já que Horários foi removido */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/eguchiodontologia" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors p-2 bg-stone-800 rounded-full">
        ...
        {/* Rodapé inferior centralizado no mobile */}
        <div className="border-t border-stone-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-stone-500 text-center md:text-left gap-4">
          <div>
          ...
          <a href="https://websiteturbo.com.br" target="_blank" rel="noopener noreferrer" className="text-stone-500 hover:text-white transition-colors font-medium">
